...
if record:
	result = cv2.VideoWriter(filename,cv2.VideoWriter_fourcc(*'MP4V'),20,(640,480))
...
while True:
    ...
    cv2.rectangle(image,(10,5),(300,110),(0,0,0),-1)
    cv2.putText(image, "FPS :"+str(fps), (20,20),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
    cv2.putText(image, "EAR :"+str(round(ear,2)), (20,50),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
    t2 = time.time()
    counts+=1
    if first_frame < 10:
